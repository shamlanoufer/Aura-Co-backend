...
if (isset($_GET['delete'])) {
    ...
    $delete_product = $conn->prepare("DELETE FROM `products` WHERE id = ? LIMIT 1");
...
if(isset($_GET['delete_order'])){
   ...
   header('location:admin_orders.php#placed-order');
   exit();
}
...
if(isset($_GET['delete_user'])){
   ...
   header('location:admin_users.php#user_accounts');
   exit();
}
...
<head>
   ...
   <title>Admin Products - Aura & Co</title>
      ...
      <div class="flex">
         ...
         <select name="category" class="box" required>
            <option value="" selected disabled>select category</option>
               ...
               <option value="personalised_jewellery">Personalised Jewellery</option>
...
<section class="show-products" id="show-products">
