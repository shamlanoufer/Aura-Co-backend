...
// Get user ID from session for normal users
$user_id = isset($_SESSION['user_id']) ? $_SESSION['user_id'] : null;
// Optionally, get admin ID if needed
$admin_id = isset($_SESSION['admin_id']) ? $_SESSION['admin_id'] : null;

// If this page is for users, check for user_id
if (!isset($user_id)) {
...
?>
    <main class="Bracelets-main">
        <div class="page-header">
            <h1>Bracelets Collection</h1>
            <p>Elegant wrist adornments for every style</p>
        </div>
...
<div class="filter-options">
                ...
                <a href="accessories.php" class="filter">Accessories</a>
   ...
   <?php
  $select_products = $conn->prepare("SELECT * FROM products WHERE category = 'bracelets'");
