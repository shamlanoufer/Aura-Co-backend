...
<body>
    ...
    <section class="search-section">
        <form action="" method="POST" class="search-form">
            <input type="text" name="search_box" placeholder="Search for jewelry..." value="<?= htmlspecialchars($search_query); ?>">
        ...
        <div class="product-grid">
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="view_page.php?pid=<?= htmlspecialchars($fetch_products['id']); ?>" class="cta-button">View Details</a>
                </div>
            </div>
            <?php
                    }
